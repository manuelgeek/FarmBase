...
$consultant_profile = new CONSULTANT();
  ...
  $name = (trim($_POST['name']));
    ...
    if(empty($imgFile)){
      $userpic = $row['photo'];
          ...
          $upload_dir = 'consult_images/'; // upload directory
        ...
        if(!isset($errMSG))
        {
          if (!$row['photo']=="" && !empty($imgFile)) {
            unlink("consult_images/".$row['photo']); 
            }

            if($consultant_profile->consultant_profile($name,$phone,$userpic))
          {
            $msg1 = "<div class='alert alert-success col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2' data-dismiss='alert'>
                  ...
                  header("refresh:3; consultant_profile");
          }
          else{
...
<html>
  ...
  <li id="header_inbox" class="dropdown">
               <!-- messages in inbox here -->         
                    ...
                    <!-- inbox dropdown end -->
        <li ><a href="home"><span class="glyphicon glyphicon"></span>&nbsp;Post Message</a></li>  
   <li class="dropdown">
        ...
        <span class=""></span>&nbsp; <?php echo $row['email']; ?>&nbsp;<span class="caret"></span></a>
              <ul class="dropdown-menu">
                 ...
                 <li class="active"><a href="consultant_profile"><span class="glyphicon glyphicon-import"></span>&nbsp;Edit Profile</a></li>
                ...
                <div class="form-group col-md-8 col-md-offset-2">
                  <div class="col-md-4 col-sm-4  ">
                    <?php if(isset($pic1)){ echo $pic1; } else { ?> 
                      <img class=" " src="consult_images/<?php echo $row['photo']; ?>"  style=" padding:0px;"  height=170px />
                    <?php } ?>
                  </div>
