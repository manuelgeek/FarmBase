  ...
  $userEmail = $row['email'];
   $id = $_GET['edit'];
          ...
          // if no error occured, continue ....
            ...
            if($consult_home->consultant_edit_post($id,$title,$phone,$description,$cartegory,$userName,$piced,$userEmail))
          {
            $msg1 = "<div class='alert alert-success col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2' data-dismiss='alert'>
                  <button class='close ' data-dismiss='alert'>&times;</button>
                  <span class='glyphicon glyphicon-info-sign'></span> &nbsp;  successfully Edited Post
                  </div>";
          }
          else{
            $msg1 = "<div class='alert alert-danger col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2' data-dismiss='alert'>
                  <button class='close ' data-dismiss='alert'>&times;</button>
                  <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Error while editing posting!
                </div>";
          }
...
<?php
                $editer = $_GET['edit'];
               $stmt = $consult_home->runQuery("SELECT * FROM message_posts WHERE ID=:email_id");
 ...
 <section>
      <div class="container" id="post_body">
            ...
            <div class=" col-md-8 col-md-offset-2 row text-center">
              <h2 class="title ">Consultant Edit  Post</h2>
              <p> Edit your post messages below</p>
      ...
      ?>  
                     <div class="col-md-8 col-md-offset-2">
                          <?php if ( $message['photo']==''){
                           echo ""; 
                             ...
                             <img  src="message_images/<?php echo $message['photo']; ?>" style="padding: 10px 0px;"  class="item_image img-responsive" />
        ...
        <form method="post" enctype="multipart/form-data" data-parsley-validate >
              <div class="form-group col-md-8 col-md-offset-2">
                ...
                <input type="text" name="title" class="form-control login-field" value="<?php echo $message['title']; ?>" placeholder="Name of Post" id="login-name" required />
            ...
            <!--   <div class="form-group col-md-8 col-md-offset-2">
              ...
              <div class="form-group col-md-8 col-md-offset-2">
              <input class="btn btn-primary  btn-block" value="Edit Message" name="btn-post" type="submit"/><br>
