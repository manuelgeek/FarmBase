...
if($_POST)
	{
		...
		$postID =  $_SESSION['$var-more'];

		$stmt = $send_message->runQuery("SELECT * FROM farmer_posts WHERE ID=:email_id");
		...
		$receiverEmail = $row['email'];
			...
			if($send_message->send_message($name,$senderEmail,$phone,$message,$postID,$receiverEmail))
			{
