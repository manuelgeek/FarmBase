              ...
              <div class="col-md-10 col-md-offset-1  col-xs-12 col-sm-12 row-eq-height  card"  id="mauni">
               ...
               <?php
                ...
                <div class="col-md-9 col-sm-9 col-xs-9">
	                <a href="consultant_inbox_view.php?message=<?php echo $row['ID']; ?>"><h4 class="itemed h4"><b><?php echo $row['name']; ?></b></h4></a>
	               
					  <a href="consultant_inbox_view.php?message=<?php echo $row['ID']; ?>"><button class="btn btn-success btn-xs" type="submit" name="btn-more" value="<?php echo $row['ID']; ?>">View message...</button></a>&nbsp;&nbsp;
					 </span>
