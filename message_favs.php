    	 ...
    	 <div class="how-works-area col-md-12">
            ...
            <div class="how-works">
            	...
            	<span class="pull-left">
            		<a href="message_favs" class="btn btn-primary"> Blog Posts</a>
            		<a href="product_favs" class="btn btn-default">Products</a>
            	</span>
                ...
                <div class="tab-content  clearfix col-md-10 col-md-offset-1 ">
                  <div class="tab-pane fade in active" id="feeds">
				  		...
				  		<div class="col-md-12  row-eq-height">
		                   <?php 
		                   $stmt = $farmer_home->runQuery("SELECT * FROM message_fav WHERE favourite = 1 AND email=:email_id");
							$stmt->execute(array(":email_id"=>$row['email']));
							while($list = $stmt->fetch(PDO::FETCH_ASSOC)){

		                    $query = "SELECT * FROM message_posts WHERE ID = '$list[postID]' ORDER BY timer DESC";       
		                    $records_per_page=6;
